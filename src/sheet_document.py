...
class SheetDocument(GObject.Object):
    ...
    #        for a couple of things already? About the real problem with the current implementation:
    #        basically filtering operation will create an entirely new array of hidden flags. Okay,
    #        let's hide the feature from the user for now, this is unfortunate but I don't want to
